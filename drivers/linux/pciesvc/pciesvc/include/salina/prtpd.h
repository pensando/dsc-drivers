...
#ifndef __PCIESVC_SALINA_PRTPD_H__
#define __PCIESVC_SALINA_PRTPD_H__
...
typedef struct {
    ...
    u_int64_t addrdw    :62;    /* target resource address */
    ...
    u_int64_t rsrv      :31;    /* unimplemented bits */
} __attribute__((packed)) prt_res_t;

/* db64/db32/db16 prt entry format */
typedef struct {
    PRT_CMN_FIELDS;
    u_int64_t lif       :12;    /* target LIF */
    ...
    u_int64_t spare     :19;    /* implemented but unused in hw */
    u_int64_t rsrv      :31;    /* unimplemented bits */
...
#endif /* __PCIESVC_SALINA_PRTPD_H__ */
