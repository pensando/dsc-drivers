...
#include "../include/linux/pds/pds_core_if.h"
#include "../include/linux/pds/pds_adminq.h"
#include "../include/linux/pds/pds_vdpa.h"
#include "../include/linux/pds/pds_auxbus.h"
...
static void pds_vdpa_kick_vq_with_data(struct vdpa_device *vdpa_dev, u32 data)
{
		struct pds_vdpa_device *pdsv = vdpa_to_pdsv(vdpa_dev);
		u16 qid = data;

		iowrite32(data, pdsv->vqs[qid].notify);
}
#endif
...
#if ( LINUX_VERSION_CODE >= KERNEL_VERSION(6,4,0) )
static int pds_vdpa_set_vq_affinity(struct vdpa_device *vdpa_dev, u16 idx,
...
#if ( LINUX_VERSION_CODE >= KERNEL_VERSION(6,4,0) )
	.kick_vq_with_data	= pds_vdpa_kick_vq_with_data,
#endif
...
#if ( LINUX_VERSION_CODE >= KERNEL_VERSION(6,4,0) )
	.set_vq_affinity	= pds_vdpa_set_vq_affinity,
#endif
};
