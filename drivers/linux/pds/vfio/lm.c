...
/*
 * This function does not exist in the upstream driver because the vfio
 * maintainer was not a fan of it. However, it is helpful when debugging things
 * from the driver, so let's keep it around for now.
 */
const char *
